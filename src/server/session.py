...
class SessionManager(object):
    ...
    def __init__(self, secret='', session_dir = '', entropy_length = 64):
        self.secret = secret
...
class TornadoSession(Session):
    ...
    def unset(self):
        self.session_manager.unset(self.request_handler, self)
    def destroy(self):
        self.session_manager.destroy(self.request_handler, self)
